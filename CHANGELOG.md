...
### Added
- **Configuration file**: Example config at `config/qwen-monitor.conf.example` for easy setup
- **Documentation**: English README with troubleshooting section for docker-compose path configuration

### Changed
- **Docs**: Translated entire README from Spanish to English
- **Docs**: Updated Quick Start guide with config file setup instructions
...
[Unreleased]: https://github.com/cativo23/cliproxy-qwen-monitor/compare/v0.4.0...HEAD
[0.4.0]: https://github.com/cativo23/cliproxy-qwen-monitor/compare/v0.3.0...v0.4.0
